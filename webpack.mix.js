...
mix.js('resources/client-js-demodavidkohen/app.js', 'public/js')
mix.js('resources/admin-js/app.js', 'public/js/admin')
    .sass('resources/sass/app.scss', 'public/css')
	.sass('resources/sass/admin/app.scss', 'public/css/admin')
    .sass('resources/sass/error.scss', 'public/css')
    .copy('resources/img-demodavidkohen', 'public/img')
    .copy('resources/sounds-demodavidkohen', 'public/sounds')
    .options({
