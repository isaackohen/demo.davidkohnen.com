                  ...
                  <tr>
                    <td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                            <b>We hope you're enjoying Awesome Co</b><br>
                            You're currently subscribed to our <b>Small</b> plan. You can enjoy all of our premium services by upgrading to our <b>Large</b> plan! No more restrictions and unlimited downloads at your fingertips!
                          </td>
                        </tr>
                        <tr>
                          <td style="text-align:center; font-size:18px;"><b> Save 20% when you upgrade now!</b></td>
                        </tr>
                      </table>
                          ...
                          <td width="150" style="width:150px;">
                            <div style="text-align:center; background-color:#48be19;"><!--[if mso]>
                                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#48be19">
                                    <w:anchorlock/>
                                    <center style="color:#ffffff;font-family:sans-serif;font-size:16px;">Upgrade Now!</center>
                                  </v:roundrect>
                                <![endif]-->
                                <!--[if !mso]><!-- --><a href="#"><table cellspacing="0" cellpadding="0" width="100%" style="width:100%"><tr><td style="background-color:#48be19;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:45px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Upgrade Now!</span></td></tr></table></a>
                                <!--<![endif]-->
                              </div>
                          </td>
                          <td class="hide-for-mobile"  width="94" style="width:94px;">
...
</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/cleave/upsell.blade.php ENDPATH**/ ?>