            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 30px">
                  ...
                  <h1>Come check out<br> Awesome Co!</h1>
                  ...
                  <br>
                  Because I've invited you, you can also use the below coupon code to receive a 30% discount on you first months subscription!<br>
                    ...
                    <tr>
                      <td style="width:130px;background:#D84A38;">
                        <div>
                          ...
                          <![endif]-->
                              <a href="#"
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">Sign up now!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  <h2>30% discount when you sign up now!</h2>
                  <br>
                  You'll be the first to hear about new arrivals, exclusive promotionas, cool collaborations, and the latest in everything.
                  <br><br>
                  Enter <strong>XLKIJP6887F</strong> when you sign up!<br>
                  <br>
                </td>
              </tr>
            </table>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="padding:4px 0 16px;">
                        <h3>Check out some of my latest posts!</h3>
                      </td>
                    </tr>
                  </table>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/narrative/invite.blade.php ENDPATH**/ ?>