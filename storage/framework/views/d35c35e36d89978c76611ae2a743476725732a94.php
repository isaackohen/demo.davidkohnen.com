...
<head>
  ...
  <title>Sunday Upsell Email</title>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing">
                      By upgrading to a full account you'll be able to enjoy unlimited downloads and no waiting times!
                    </td>
                  </tr>
                </table>
            ...
            <tr>
                ...
                <tr>
                  ...
                  <td width="360" class="w320">
                    <table cellspacing="0" cellpadding="0" class="w280 w100p">
                      <tr>
                        <td class="mobile-center activate-now" style="color:#27aa90; font-size: 30px; font-weight: 600; line-height:30px; text-align:left;" >
                          Upgrade now and <br>receive a 20% <br>discount!
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table cellspacing="0" cellpadding="0" width="100%">
                <tr>
                  ...
                  <br>
                    Find out what your missing! <br><br>
                ...
                <tr>
                  ...
                  <br>
                    <div><!--[if mso]>
                      ...
                      <![endif]-->
                          <a href="http://"
                        style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Upgrade</a>
                          <!--[if mso]>
                        </center>
                      </v:rect>
                    <![endif]--></div>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/sunday/upsell.blade.php ENDPATH**/ ?>