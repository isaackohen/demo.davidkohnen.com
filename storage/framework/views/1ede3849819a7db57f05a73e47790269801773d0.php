    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              We changed the password on your account, as you asked. If you'd like to view or change your account information, please visit <a href="">Your Account</a>.
            </td>
          </tr>
          <tr>
            <td class="button">
        ...
        <tr>
          <td class="content-padding">
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td class="header-md">
                  Have you seen the newest deals?
                </td>
              </tr>
            </table>
          </td>
                    ...
                    <tr>
                      <td class="block-rounded">
                        <table cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td class="info-img">
                              <img width="258" height="210" class="info-img" src="http://s3.amazonaws.com/swu-filepicker/RPezUIwPRv8pjatAAH1E_item_images_19.jpg" alt="img" />
                            </td>
                          </tr>
                          <tr>
                            <td style="padding: 15px;">
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/oxygen/ping.blade.php ENDPATH**/ ?>