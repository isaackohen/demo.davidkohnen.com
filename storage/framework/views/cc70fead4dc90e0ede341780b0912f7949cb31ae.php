<?php $__env->startSection('title', 'Edit '.$name.' Template'); ?>
...
<div class="col-lg-12 col-md-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('viewMailable', ['name' => $name])); ?>"><?php echo e($name); ?></a></li>
            ...
            <div class="row my-4">
                    ...
                    <div id="accordion">
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                          <div class="card-body">
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Mailable:</b> <a href="<?php echo e(route('viewMailable', ['name' => $name])); ?>"><?php echo e($name); ?></a></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Namespace:</b> <?php echo e($templateData['namespace']); ?></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred"><?php echo e($templateData['is_markdown'] ? 'Markdown' : 'View'); ?>:</b> <?php echo e($templateData['template_name']); ?></p>
                        </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link <?php echo e(!is_null($templateData['text_template']) ? '' : 'disabled'); ?>" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Plain Text</a>
                      </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                      ...
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <?php $__currentLoopData = $templateData['view_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                               <?php if(isset($param['data']['type']) && $param['data']['type'] === 'model'): ?>
                                    <div class="btn-group dropright">
                                      <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" maileclipse-data-toggle="tooltip" data-placement="top" title="Elequent Model">
                                        <i class="fas fa-database mr-1"></i><?php echo e($param['key']); ?>

                                      </button>
                                      <div class="dropdown-menu">

                                        <!-- Dropdown menu links -->
                                        <?php if( !$param['data']['attributes']->isEmpty() ): ?>
                                                <a class="dropdown-item view_data_param" param-key="<?php echo e($param['key']); ?>" href="#param"><?php echo e($param['key']); ?></a>
                                                <div class="dropdown-divider"></div>
                                            <?php $__currentLoopData = $param['data']['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a class="dropdown-item is-attribute view_data_param" param-parent-key="<?php echo e($param['key']); ?>" param-key="<?php echo e($key); ?>" href="#param"><?php echo e($key); ?></a>
                                    ...
                                    <?php elseif(isset($param['data']['type']) && $param['data']['type'] === 'elequent-collection'): ?>

                                        <button type="button" class="btn btn-info btn-sm view_data_param" maileclipse-data-toggle="tooltip" data-placement="top" title="Elequent Collection" param-key="<?php echo e($param['key']); ?>">
                                        <i class="fa fa-table mr-1" aria-hidden="true"></i><?php echo e($param['key']); ?>

                                        </button>

                                    <?php elseif(isset($param['data']['type']) && $param['data']['type'] === 'collection'): ?>

                                        <button type="button" class="btn btn-success btn-sm view_data_param" maileclipse-data-toggle="tooltip" data-placement="top" title="Collection" param-key="<?php echo e($param['key']); ?>">
                                        <i class="fa fa-table mr-1" aria-hidden="true"></i><?php echo e($param['key']); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm view_data_param" maileclipse-data-toggle="tooltip" data-placement="top" title="Simple Variable" param-key="<?php echo e($param['key']); ?>">
                                        <i class="fa fa-anchor mr-1" aria-hidden="true"></i><?php echo e($param['key']); ?>
                        ...
                        <textarea id="template_editor" cols="30" rows="10"><?php echo e($templateData['template']); ?></textarea>
                      </div>
                      <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <?php if(!is_null($templateData['text_template'])): ?>
                            <textarea id="plain_text" cols="30" rows="10"><?php echo e($templateData['text_template']); ?></textarea>
                        <?php endif; ?>
                      </div>
                    </div>
...
<?php if( isset($templateData['template']) ): ?>

var templateID = "template_view_<?php echo e($name); ?>_<?php echo e($templateData['template_name']); ?>";

<?php if( $templateData['is_markdown'] ): ?>
    ...
    var simplemde = new SimpleMDE(
        ...
        previewRender: function(plainText, preview) {
            $.ajax({
                  method: "POST",
                  url: "<?php echo e(route('previewMarkdownView')); ?>",
                  data: { markdown: plainText, namespace: '<?php echo e(addslashes($templateData['namespace'])); ?>', viewdata: "<?php echo e(preg_replace("/\r\n/","<br />", serialize($templateData['view_data']))); ?>", name: '<?php echo e($name); ?>' }
...
[endcomponent]: #
    ...
    submitCallback: function () {
        ...
        if (typeof plaintextEditor !== 'undefined' && plaintextEditor.getValue() !== ''){
                axios.post('<?php echo e(route('parseTemplate')); ?>', {
                markdown: plaintextEditor.getValue(),
                viewpath: "<?php echo e(base64_encode($templateData['text_view_path'])); ?>"
            })
        }

        axios.post('<?php echo e(route('parseTemplate')); ?>', {
            markdown: simplemde.codemirror.getValue(),
            viewpath: "<?php echo e(base64_encode($templateData['view_path'])); ?>"
        })
    ...
    function viewMarkdownParser(plainText){
        ...
        $.ajax({
          ...
          data: {
            markdown: plainText,
            namespace: '<?php echo e(addslashes($templateData['namespace'])); ?>',
            viewdata: "<?php echo e(preg_replace("/\r\n/","<br />", serialize($templateData['view_data']))); ?>",
            name: '<?php echo e($name); ?>'
          }
...
<?php echo $__env->make('maileclipse::layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/sections/edit-mailable-template.blade.php ENDPATH**/ ?>