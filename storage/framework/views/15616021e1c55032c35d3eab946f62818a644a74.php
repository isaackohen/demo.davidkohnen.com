<?php $__env->startSection('title', 'Edit Template ' . ucfirst($template['name'])); ?>
...
<div class="col-lg-12 col-md-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo e(ucfirst($template['name'])); ?></li>
      </ol>
    </nav>
        <div class="container">
            <div class="row my-4">
                    ...
                    <div id="accordion">
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                          <div class="card-body">
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Name:</b> <?php echo e(ucfirst($template['name'])); ?></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Slug:</b> <?php echo e($template['slug']); ?></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Description:</b> <?php echo e($template['description']); ?></p>
                            
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template View:</b> <?php echo e('maileclipse::templates.'.$template['slug']); ?></p>

                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Type:</b> <?php echo e(ucfirst($template['template_type'])); ?></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Name:</b> <?php echo e(ucfirst($template['template_view_name'])); ?></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Skeleton:</b> <?php echo e(ucfirst($template['template_skeleton'])); ?></p>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <textarea id="template_editor" cols="30" rows="10"><?php echo e($template['template']); ?></textarea>
                      </div>
                    </div>
...
$(document).ready(function(){
	 ...
	 var templateID = "<?php echo e("template_view_".$template['slug']); ?>";
	 ...
	 $('.edit-template').click(function(){
		...
		notie.input({
                  ...
                  submitCallback: function (templatedescription) {
	                  axios.post('<?php echo e(route('updateTemplate')); ?>', {
					  	templateslug: '<?php echo e($template['slug']); ?>',
					  	title: templatename,
	...
	$('.delete-template').click(function(){
		...
		notie.confirm({
	    	...
	    	submitCallback: function () {
	    		...
	    		axios.post('<?php echo e(route('deleteTemplate')); ?>', { 
				  	templateslug: '<?php echo e($template['slug']); ?>',
				  })
		    ...
		    .then(function (response) {
		    	...
		    	if (response.data.status == 'ok'){
				    ...
				    setTimeout(function(){
                                window.location.replace('<?php echo e(route('templateList')); ?>');
                    }, 3000);
	...
	<?php if($template['template_type'] === 'markdown'): ?>
	...
	var simplemde = new SimpleMDE(
		...
		previewRender: function(plainText, preview) {
			...
			$.ajax({
				  method: "POST",
				  url: "<?php echo e(route('previewTemplateMarkdownView')); ?>",
				  data: { markdown: plainText, name: '<?php echo e($template['slug']); ?>' }
	...
	$('.save-template').click(function(){
		...
		notie.confirm({
	    	...
	    	submitCallback: function () {
	    		...
	    		axios.post('<?php echo e(route('parseTemplate')); ?>', { markdown: simplemde.codemirror.getValue(), viewpath: "<?php echo e($template['slug']); ?>", template: true })
		 ...
		 notie.confirm({
	    	...
	    	submitCallback: function () {
	    		...
	    		axios.post('<?php echo e(route('parseTemplate')); ?>', {
	    			markdown: tinymce.get('template_editor').getContent(), viewpath: "<?php echo e($template['slug']); ?>", template: true
	    		})
...
<?php echo $__env->make('maileclipse::layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/sections/edit-template.blade.php ENDPATH**/ ?>