...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Go Invitation Email</title>
    <!-- Designed by https://github.com/kaytcat -->
    <!-- Header and profile image designed by Freepik.com -->
              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">Come check out my stuff!</span><br><br>
                    You won't believe how easy and fun Awesome co is!
                    <br>
                    <br>
                      <div><!--[if mso]>
                        ...
                        <![endif]-->
                            <a href="http://"
                        style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Sign up now!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                        <![endif]-->
                ...
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td class="mobile-center">
                          <span class="header">You get a 20% discount for signing up!</span><br>
                          Discount Code: <span style="color:#2b934f;"> 45A9E77DGW8455</span>
                        </td>
                        <td class="mobile-hide">
                          <img width="84" height="82" src="https://www.filepicker.io/api/file/zef0p13mRmKdcOhbUVZ4" alt="dollar symbol">
                        </td>
                      </tr>
                    </table>
                    ...
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td class="mobile-block" style="vertical-align:top; padding: 10px;">
                          <br>
                          <img width="85" height="85" src="https://www.filepicker.io/api/file/iYDaeAgeRSquDberfMZN" alt="profile image"><br>
                          <span style="font-size:12px;">User:<a href="#"> John Doe</a></span>
                        </td>
                        <td class="mobile-block" style="padding: 0 25px;">
                          <br>
                          Hey Bob, <br>
                          <br>
                          I set up an Awesome Co profile where I can do tons of really awesome stuff. I want you to follow me so we can keep in touch!
                          <br><br>
                          See you soon!
                        </td>
                      </tr>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/go/invite.blade.php ENDPATH**/ ?>