                        ...
                        <tr>
                          <td>
                            <table cellspacing="0" cellpadding="0" width="100%">
                              ...
                              <tr>
                                <td class="progress-text progress-text-padded">Step One</td>
                                <td class="progress-text progress-text-padded">Step Two</td>
                                <td class="progress-text progress-text-padded" style="padding-left:10px">Step Three</td>
                          ...
                          <td width="150" style="width:150px;">
                            <div style="text-align:center; background-color:#48be19;"><!--[if mso]>
                                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#48be19">
                                    <w:anchorlock/>
                                    <center style="color:#ffffff;font-family:sans-serif;font-size:16px;">My Account</center>
                                  </v:roundrect>
                                <![endif]-->
...
</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/cleave/progress.blade.php ENDPATH**/ ?>