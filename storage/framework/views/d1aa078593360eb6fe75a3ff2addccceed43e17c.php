...
<head>
  ...
  <title>Skyline Upsell Email</title>
  <style type="text/css">
              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h1>DISCOVER MORE!</h1><br>
                    <h2>Upgrade your account know and find out what you've been missing.</h2>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      <td style="text-align: center;">
                        <h3>receive 20% off if you upgrade now!</h3>
                      </td>
                    </tr>
                  </table>
                </td>
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        You'll be the first to hear about new arrivals, exclusive promotions, cool collaborations and the latest in everything!
                      <br>
                      <br>
                      ...
                      <td style="width:150px; background-color: #3bcdc3;">
                        <div><!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#3bcdc3">
                              <w:anchorlock/>
                              <center style="color:#ffffff;font-family:sans-serif;font-size:13px;">Upgrade</center>
                            </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-- --><a href="#"><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="background-color:#3bcdc3;border-radius:0px;color:#ffffff;display:inline-block;font-family:'Lato', Helvetica, Arial, sans-serif;font-weight:bold;font-size:13px;line-height:33px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Upgrade</span></td></tr></table></a>
                          <!--<![endif]-->
                        </div>
                      </td>
                      <td>
...
</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/skyline/upsell.blade.php ENDPATH**/ ?>