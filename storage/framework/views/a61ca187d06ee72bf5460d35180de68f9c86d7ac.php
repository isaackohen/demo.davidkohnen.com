            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">Hi &lt;First Name&gt;</td>
                  </tr>
                  <tr>
                    <td height="17" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" class="em_font1" style="font-family:'Open Sans', Arial, sans-serif; font-size:50px; font-weight:bold; line-height:50px; color:#30373b; text-transform:uppercase;">we miss you!</td>
                  </tr>
                  <tr>
                    <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:20px; color:#30373b;">Enjoy 50% off your next purchase!</td>
                  </tr>
                  <tr>
                    <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td valign="top" align="center">
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;">off50code</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center">
                      <img src="https://www.sendwithus.com/assets/img/emailmonks/images/coupon.jpg" width="600" height="300" style="display:block;font-family:'FISHfingers', Tahoma, Geneva, sans-serif; font-size:40px; line-height:42px; color:#feae39; text-transform:uppercase; letter-spacing:5px;" border="0" alt="" class="em_full_img" />
                    </td>
                  </tr>
                  <tr>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/coupon.blade.php ENDPATH**/ ?>