													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h3-2-center" style="color:#1e1e1e; font-family:Arial, sans-serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center; letter-spacing:5px">IT‘S YOUR</div>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
											<tr>
												<td>
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h3-1-center" style="color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</div>
																...
																<div class="h4-center" style="color:#1e1e1e; font-family:Arial, sans-serif; min-width:auto !important; font-size:18px; line-height:24px; text-align:center">
																	<strong>ENJOY <span style="color: #a88123;">15%</span> OFF</strong>
																</div>
																							...
																							<tr>
																								...
																								<td bgcolor="#d2973b">
																									<div class="text-btn" style="color:#ffffff; font-family:Arial, sans-serif; min-width:auto !important; font-size:16px; line-height:20px; text-align:center">
																										<a href="#" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">LET'S CELEBRATE</span></a>
																									</div>
																								</td>
													...
													<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="https://d1pgqke3goo8l6.cloudfront.net/INqi55TjRoOqXGNSngcN_img_1.jpg" border="0" width="600" height="220" alt="" /></a></div>
												</td>
											</tr>
										</table>
										<!-- END Body -->
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/goldstar/birthday.blade.php ENDPATH**/ ?>