            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td  align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#feae39;">let us know</td>
                  </tr>
                  <tr>
                    <td height="16" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/img1.jpg" width="408" height="46" style="display:block;font-family: Arial, sans-serif; font-size:24px; line-height:28px; color:#feae39; letter-spacing:5px;max-width:408px;"  border="0" alt="WHAT YOU THINK!" class="em_full_img"/></a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" valign="top">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td bgcolor="#feae39" width="1"></td>
                          <td align="center" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td bgcolor="#feae39" height="1" style="line-height:0px; font-size:0px;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/spacer.gif" width="1" height="1" alt=" "  style="display:block;" border="0" /></td>
                              </tr>
                              <tr>
                                <td height="36" class="em_height">&nbsp;</td>
                              </tr>
                              <tr>
                                <td   align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#feae39;"><a href="#" target="_blank" style="color:#feae39; text-decoration:none;"> Click to rate our services</a></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" valign="top" >
                                  <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper" style="max-width:400px;">
                                    <tr>
                                      <td  width="9">&nbsp;</td>
                                      <td  width="45" bgcolor="#feae39" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="#" target="_blank" style="color:#ffffff; text-decoration:none;"> 1</a></td>
                                      <td class="em_space" width="39">&nbsp;</td>
                                      <td width="45" bgcolor="#feae39" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="#" target="_blank" style="color:#ffffff; text-decoration:none;"> 2</a></td>
                                      <td class="em_space"  width="39">&nbsp;</td>
                                      <td width="45" bgcolor="#feae39" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="#" target="_blank" style="color:#ffffff; text-decoration:none;"> 3</a></td>
                                      <td class="em_space"  width="39">&nbsp;</td>
                                      <td width="45" bgcolor="#feae39" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="#" target="_blank" style="color:#ffffff; text-decoration:none;"> 4</a></td>
                                      <td class="em_space"   width="39">&nbsp;</td>
                                      <td width="45" bgcolor="#feae39" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;"><a href="#" target="_blank" style="color:#ffffff; text-decoration:none;"> 5</a></td>
                                      <td  width="10">&nbsp;</td>
                                    </tr>
                                  </table>
                                </td>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/rating.blade.php ENDPATH**/ ?>