...
<head>
  ...
  <title>Skyline Progress Email</title>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                              <tr>
                                ...
                                <td style="text-align:left;">
                                  <img class="image-resize" width="83" height="69" src="https://www.filepicker.io/api/file/F9SkjWD4TqNAepL8wTQI">
                                </td>
                                <!-- FOR STEP ONE - Use this url:
                                https://www.filepicker.io/api/file/GsE0qBfDTeih1HDdQCoN  -->

                                <!-- FOR STEP TWO, THREE AND FOUR - Use this url:
                                https://www.filepicker.io/api/file/F9SkjWD4TqNAepL8wTQI  -->


                                <td style="text-align:left;">
                                  <img class="image-resize" width="83" height="69" src="https://www.filepicker.io/api/file/OoxZ43uKTQfhdXLLMKRA">
                                </td>
                                <!-- FOR STEP ONE - Use this url:
                                https://www.filepicker.io/api/file/QyjvncIvTdWVAklJmFeb  -->

                                <!-- FOR STEP TWO - Use this url:
                                https://www.filepicker.io/api/file/cDXDdFf6RUcpaZWYyjGS  -->

                                <!-- FOR STEP THREE AND FOUR - Use this url:
                                https://www.filepicker.io/api/file/OoxZ43uKTQfhdXLLMKRA  -->


                                <td style="text-align:left;">
                                  <img class="image-resize" width="83" height="69" src="https://www.filepicker.io/api/file/j2AL73heQ7CYVhDeW3Sk">
                                </td>

                                <!-- FOR STEP ONE AND TWO - Use this url:
                                https://www.filepicker.io/api/file/sitgp9yR0GIMqXXfN3qQ  -->

                                <!-- FOR STEP THREE - Use this url:
                                https://www.filepicker.io/api/file/j2AL73heQ7CYVhDeW3Sk  -->

                                <!-- FOR STEP FOUR - Use this url:
                                https://www.filepicker.io/api/file/Q6CSbvykTk2HtdTxz7hw  -->


                                <td style="text-align:left;">
                                  <img class="image-resize" width="83" height="69" src="https://www.filepicker.io/api/file/2foNuGNTSweHSvsAVoL9">
                                </td>

                                <!-- FOR STEP ONE, TWO, Three - Use this url:
                                https://www.filepicker.io/api/file/2foNuGNTSweHSvsAVoL9  -->

                                <!-- FOR STEP FOUR - Use this url:
                                https://www.filepicker.io/api/file/XEYXgkeTRVSDyyx73gh1  -->


                              </tr>
                              <tr>
                                <td class="font-smaller" style="text-align:center;">Step One</td>
                                <td class="font-smaller" style="text-align:center;">Step Two</td>
                                <td class="font-smaller" style="text-align:center;"><b>Step Three</b></td>
                                <td class="font-smaller" style="text-align:center;">Done!</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                ...
                <td>
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        You're almost there! You've completed 3 out of 4 steps. We just need to to update your contact information and that's it!
                        <br><br>
                        Please click below to finish updating your account.
                      <br>
                      <br>
                      ...
                      <td style="width:150px; background-color: #3bcdc3;">
                        <div><!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#3bcdc3">
                              <w:anchorlock/>
                              <center style="color:#ffffff;font-family:sans-serif;font-size:13px;">Update now!</center>
                            </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-- --><a href="#"><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="background-color:#3bcdc3;border-radius:0px;color:#ffffff;display:inline-block;font-family:'Lato', Helvetica, Arial, sans-serif;font-weight:bold;font-size:13px;line-height:33px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Update now!</span></td></tr></table></a>
                          <!--<![endif]-->
                        </div>
                      </td>
                      <td>
...
</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/skyline/progress.blade.php ENDPATH**/ ?>