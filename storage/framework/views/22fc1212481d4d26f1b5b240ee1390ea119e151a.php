...
<html>
    ...
    <body>
        ...
        <div id="app">
        <div class="preloader">
            <img class="ld ld-bounce" style="height: 60px; position: absolute; top: 0; bottom: 0; margin: auto; left: 0; right: 0;" src="<?php echo e(asset(env('MIX_APP_BIG_PRELOADER')) ?? "https://games.cdn4.dk/loading.gif"); ?>">
        </div>
            <layout></layout>
        </div>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>