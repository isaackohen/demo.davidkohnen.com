            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="middle" align="center"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/thnk_u.jpg" width="300" height="45" alt="ALMOST DONE" style="display:block; font-family:Arial, sans-serif; letter-spacing:6px; font-size:25px; line-height:42px; color:#feae39;max-width:398px;" class="em_full_img" border="0" /></td>
                  </tr>
                  <tr>
                    <td height="14" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:22px; color:#feae39; text-transform:uppercase;">for your order!</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td valign="top" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px;line-height:22px; font-weight:bold; color:#30373b; text-transform:uppercase;">Review your invoice</td>
                  </tr>
                  <tr>
                            ...
                            <table width="290" border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper" bgcolor="#f6f7f8">
                              <tr>
                                <td align="center" valign="middle" class="em_font1" height="42" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#30373b; text-transform:uppercase;">
                                  <span style="color:#feae39;">order number :</span> A80SD99
                                </td>
                              </tr>
                            </table>
                              ...
                              <tr>
                                <td valign="top" class="em_pad_top">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0"  bgcolor="#f6f7f8" >
                                    <tr>
                                      <td align="center" valign="middle" class="em_font1" height="42" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#30373b; text-transform:uppercase;">
                                        <span style="color:#feae39;">Date shipped :</span> aug 2&zwnj;8, 201&zwnj;6
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="left" valign="top"  class="em_font1" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#feae39; text-transform:uppercase;">shipping add&zwnj;ress : &nbsp;<span style=" color:#30373b;">first name here</span></td>
                              </tr>
                              <tr>
                                <td valign="top">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr>
                                            <td align="left" class="em_font2" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px;line-height:20px; color:#30373b;">123, Addr&zwnj;ess line 1, Addr&zwnj;ess line 2, Land&zwnj;mark,
                                              City, St&zwnj;ate, Coun&zwnj;try &#45; Pin.
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                  ...
                  <tr>
                    <td valign="top">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                ...
                                <td width="255" valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b; font-weight:bold;">Item</td>
                                <td width="5"></td>
                                <td width="35" class="em_width55" valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b; font-weight:bold;">Qty</td>
                                <td width="138" class="em_hide"></td>
                                <td width="5"></td>
                                <td align="right" class="em_width75" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b; font-weight:bold;">Total</td>
                                <td width="30" class="em_hide">&nbsp;</td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td width="30" class="em_hide">&nbsp;</td>
                                <td width="255" valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">Product name here</td>
                                <td width="5"></td>
                                <td width="35" class="em_width55" valign="top" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">1</td>
                                 <td width="138" class="em_hide"></td>
                                <td width="5"></td>
                                <td align="right" valign="top" class="em_width75" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">$00.00</td>
                                <td width="30" class="em_hide">&nbsp;</td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td width="30" class="em_hide">&nbsp;</td>
                                <td valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">Subtotal :</td>
                                <td width="5"></td>
                                <td align="right" width="127" valign="top" class="em_width75" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">$00.00</td>
                                <td width="30" class="em_hide">&nbsp;</td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td width="30" class="em_hide">&nbsp;</td>
                                <td valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">Shipping :</td>
                                <td width="5"></td>
                                <td align="right" width="127" valign="top" class="em_width75" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:24px; color:#30373b;">$00.00</td>
                                <td width="30" class="em_hide">&nbsp;</td>
                              </tr>
                        ...
                        <tr>
                          <td height="1" bgcolor="#feae39" style="font-size:0px;line-height:0px;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/spacer.gif" width="1" height="1" alt="" style="display:block;" border="0" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td align="right" style="font-family:'Open Sans', Arial, sans-serif; font-size:20px; line-height:24px; color:#30373b; font-weight:bold;">Total: &nbsp;&nbsp; $00.00</td>
                                <td width="30" class="em_hide">&nbsp;</td>
                              </tr>
                            </table>
                          </td>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px; color:#30373b;">Feel free to review your invoice below or click the<br class="em_hide"/>
                  ...
                  <tr>
                    <td valign="top" align="center">
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;"><a href="#" target="_blank" style="line-height:45px; display:block; color:#ffffff; text-decoration:none;">My account</a></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/receipt.blade.php ENDPATH**/ ?>