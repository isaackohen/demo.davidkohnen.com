      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <!-- === //NEVIGATION SECTION === -->
            <!-- === ORDER SHIPING SECTION === -->
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="49" class="em_height">&nbsp;</td>
                  </tr>
                  <tr>
                    <td valign="middle" align="center"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/shipped.png" width="326" height="42" alt="GOOD NEWS" style="display:block; font-family:Arial, sans-serif; font-size:25px; line-height:42px; color:#c27cbb;max-width:326px;" class="em_full_img" border="0" /></td>
                  </tr>
                  <tr>
                    <td height="15" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; line-height:20px; color:#30373b;">Your order has shipped!</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:20px; color:#30373b;">To track your order or make<br class="em_hide" />
                      any changes please click the button below.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td valign="top" align="center">
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;"><a href="#" target="_blank" style="text-decoration:none; color:#ffffff; display:block; line-height:45px;">My order</a></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  <tr>
                    <td height="48" class="em_height">&nbsp;</td>
                  </tr>
                  <tr>
                    <td valign="top">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <table width="290" border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper" bgcolor="#f6f7f8">
                              <tr>
                                <td align="center" valign="middle" class="em_font1" height="42" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#30373b; text-transform:uppercase;">
                                  <span style="color:#feae39;">order number :</span> A8&zwnj;0SD99
                                </td>
                              </tr>
                            </table>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px; color:#30373b; font-style:italic;">Thank you foy your business.<br />
                      Please <a href="#" target="_blank" style="text-decoration:underline; color:#feae39;">contact us</a> with any questions regarding your order,
                    </td>
                  </tr>
                  <tr>
                    <td height="40" class="em_height">&nbsp;</td>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/shipped.blade.php ENDPATH**/ ?>