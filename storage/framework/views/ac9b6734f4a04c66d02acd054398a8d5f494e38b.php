...
<head>
  ...
  <title>Narrative Upsell Email</title>
  <style type="text/css">
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                  ...
                  <h1>Upgrade to a full account!</h1>

                  <br>
                  By upgrading to a full account you'll be able to enjoy unlimited downloads and no waiting times!<br><br>

                  Upgrade now and you'll also receive a 20% discount! Find out what you've been missing.<br>
                  <br>
                    ...
                    <tr>
                      <td style="width:130px;background:#D84A38;">
                        <div>
                          ...
                          <![endif]-->
                              <a href="#"
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">Upgrade!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  <h2>20% Off if you upgrade now!</h2>
                  <br>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/narrative/upsell.blade.php ENDPATH**/ ?>