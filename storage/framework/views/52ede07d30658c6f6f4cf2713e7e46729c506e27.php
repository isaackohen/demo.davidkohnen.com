            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Would you recommend us?</h2><br>

                  Your opinion is important to us! Please take a moment and let us know how likely are you to recommend us to a friend?<br>

                  <br />
                  Just click on one of the buttons below. 0 being not likely and 10 being very likely. It's that simple!
                  <br>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      <td align="right" valign="bottom" style="padding-bottom:0; vertical-align:bottom;">
                        <img  style="vertical-align:bottom;" src="https://www.filepicker.io/api/file/lejtMuktTJim5ANd8bO9"  width="174" height="294" />
                      </td>
                    </tr>
                  </table>
                </td>
                ...
                <br />
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <td>
                        <div><!--[if mso]>
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:23px;v-text-anchor:middle;width:34px;" stroke="f" fill="t">
                            <v:fill type="tile" src="https://www.filepicker.io/api/file/gfdSlreTSXaa07axKLVO" color="#f8f8f8" />
                            <w:anchorlock/>
                    ...
                    <tr>
                      <td class="pusher">&nbsp;</td>
                      <td class="rate-num">0</td>
                      <td class="rate-num">1</td>
                      <td class="rate-num">2</td>
                      <td class="rate-num">3</td>
                      <td class="rate-num">4</td>
                      <td class="rate-num">5</td>
                      <td class="rate-num">6</td>
                      <td class="rate-num">7</td>
                      <td class="rate-num">8</td>
                      <td class="rate-num">9</td>
                      <td class="rate-num">10</td>
                      <td class="pusher">&nbsp;</td>
                    </tr>
                  </table>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/narrative/survey.blade.php ENDPATH**/ ?>