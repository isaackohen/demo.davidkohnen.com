...
<?php $__env->startSection('content'); ?>
    <h1 class="page-header"><?php echo app('translator')->get('Logs'); ?></h1>
        ...
        $(function () {
            ...
            $("a[href=#delete-log-modal]").on('click', function(event) {
                ...
                var date    = $(this).data('log-date'),
                    message = "<?php echo app('translator')->get('Are you sure you want to DELETE this log file: :date ?'); ?>";
...
<?php echo $__env->make('log-viewer::bootstrap-3._master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/arcanedev/log-viewer/views/bootstrap-3/logs.blade.php ENDPATH**/ ?>