            ...
            <div class="card-body p-0">
                <div class="media p-3">
                    <div class="media-body">
                        ...
                        <h2 class="mb-0"><?php echo e(\App\User::where('bot', '!=', true)->count()); ?></h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-6">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <h2 class="mb-0"><?php echo e(\Illuminate\Support\Facades\DB::table('users')->where('referral', '!=', null)->count()); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body pb-0">
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="today" class="apex-charts mt-3"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="week" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="d15" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="m1" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="m3" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="m6" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
                ...
                ?>
                <div id="<?php echo e($chart->id); ?>" data-chart-u="y" class="apex-charts mt-3" style="display: none"></div>
                <?php echo e($chart->script()); ?>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/resources/views/admin/analytics.blade.php ENDPATH**/ ?>