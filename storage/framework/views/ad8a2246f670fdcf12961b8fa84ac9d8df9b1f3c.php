      ...
      <table>
        <tr>
          <th>
                  ...
                  <div class="button">
                    <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:30px;v-text-anchor:middle;width:100px;" arcsize="8%" strokecolor="#f7931d" fillcolor="#f7931d">
                          <w:anchorlock/>
                          <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Track Order</center>
                        </v:roundrect>
                    <![endif]-->
                    <a href="#" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:30px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;mso-hide:all;">Track Order</a>
                  </div>
                </th>
<th class="expander"></th>
        </tr>
               ...
               <table class="row"><tbody><tr> <!-- spacer  -->
                    <th class="small-12 large-12 columns first last">
      <table>
        <tr>
          <th>
      ...
      <table>
        <tr>
          <th>
              ...
              <table class="row"><tbody><tr> <!-- This container adds the gap between digest content and CTA  -->
                    <th class="small-12 large-12 columns first last">
      <table>
        <tr>
          <th>
...
<th class="expander"></th>
               ...
               <table class="row"><tbody><tr> <!-- secondary email content -->
                    <th class="small-12 large-12 columns first last">
      <table>
        <tr>
          <th>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/meow/confirmation.blade.php ENDPATH**/ ?>