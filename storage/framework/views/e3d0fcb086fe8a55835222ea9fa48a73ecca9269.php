            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#30373b;  font-weight:bold;"><span style="color:#feae39;">@First  Name</span> has invited you to join Company Name!</td>
                  </tr>
                  <tr>
                    <td height="30" class="em_height">&nbsp;</td>
                  </tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="center" valign="top"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/activation.jpg" width="120" height="120" alt="" style="display:block;" border="0" /></td>
                              </tr>
                              <tr>
                                <td height="21" class="em_height">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="center"  style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#ffffff;  font-weight:bold;">@First  Name</td>
                              </tr>
                              <tr>
                                <td height="18" style="line-height:1px; font-size:1px;" class="em_height">&nbsp;</td>
                              </tr>
                              <tr>
                                <td  align="center"  style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:24px; color:#ffffff; font-style:italic;">&ldquo;Hey Name, here&rsquo;s your invite!<br class="em_hide" />
                                  Come check out my profile page when you have a chance.<br class="em_hide" />
                                  You&rsquo;ll love it!&rdquo;
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="210" bgcolor="#ffffff" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="45" align="center" valign="middle" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px;color:#feae39; font-weight:bold; text-transform:uppercase;"><a href="#" target="_blank" style="text-decoration:none; color:#feae39; line-height:45px; display:block;">sign up</a></td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:20px; line-height:22px; color:#30373b;  font-weight:bold; text-transform:uppercase;">Upcoming Products</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" valign="top">
                      <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="center" valign="top">
                            <table width="290" align="left" class="em_wrapper" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center" valign="top" class="em_pad_bottom">
                                  <table width="290" align="center"  border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td align="left" valign="top" >
                                        <table width="135" align="left"  class="em_wrapper" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/img_135X135.jpg" width="135" height="135" alt="img_135X135" style="display:block; font-family:Arial, sans-serif; font-size:15px; line-height:135px; color:#000000;" border="0" /></td>
                                          </tr>
                                          <tr>
                                            <td height="12" style="line-height:1px; font-size:1px;">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td  align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:18px; color:#000000;">Product Name</td>
                                          </tr>
                                        </table>
                                      </td>
                                      <td align="right" valign="top" >
                                        <table width="135" align="right"  class="em_wrapper" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/img_135X135.jpg" width="135" height="135" alt="img_135X135" style="display:block; font-family:Arial, sans-serif; font-size:15px; line-height:135px; color:#000000;" border="0" /></td>
                                          </tr>
                                          <tr>
                            ...
                            <table width="290" align="right" class="em_wrapper" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center" valign="top" >
                                  <table width="290" align="center"  border="0" cellspacing="0" cellpadding="0">
                                    <tr>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/activation.blade.php ENDPATH**/ ?>