...
<head>
  ...
  <title>Skyline Invitation Email</title>
  <style type="text/css">
              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h2>You won't believe what you're missing!</h2>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td style="padding-bottom:0px;" class="mobile-img">
                      <table cellspacing="0" cellpadding="0" width="120">
                        <tr>
                          ...
                          <img  style="border:1px solid #a1a1a1;" src="https://www.filepicker.io/api/file/OqRXT4JuRbmXSgbxccgK"  width="90" height="90" alt="profile"/>
                          </td>
                        </tr>
                        <tr>
                         <td style="font-size:12px; padding-top:5px; text-align:center;">
                           User: <a style="color:#3bcdc3;" href="">Jon Doe</a>
                          </td>
                        </tr>
                      </table>
                    </td>
                    <td class="mobile-block mobile-padding" style="text-align:left;">
                      ...
                      Because I've invited you, you can now receive 20% off when you sign up!
                      ...
                      <td style="width:150px; background-color: #3bcdc3;">
                        <div><!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#3bcdc3">
                              <w:anchorlock/>
                              <center style="color:#ffffff;font-family:sans-serif;font-size:13px;">Sign up</center>
                            </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-- --><a href="#"><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="background-color:#3bcdc3;border-radius:0px;color:#ffffff;display:inline-block;font-family:'Lato', Helvetica, Arial, sans-serif;font-weight:bold;font-size:13px;line-height:33px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Sign up</span></td></tr></table></a>
                          <!--<![endif]-->
                        </div>
                      </td>
                      <td>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/skyline/invite.blade.php ENDPATH**/ ?>