<?php $__env->startSection('title', 'Mailables'); ?>
...
<div class="col-lg-10 col-md-12">
                ...
                <div class="card my-4">
                    <div class="card-header d-flex align-items-center justify-content-between"><h5><?php echo e(__('Mailables')); ?></h5>

                        <?php if(!$mailables->isEmpty()): ?>
                            <a class="btn btn-primary" href="#newMailableModal" data-toggle="modal" data-target="#newMailableModal"><?php echo e(__('Add Mailable')); ?></a>
                        <?php endif; ?>
                        <!-- Modal -->
                    </div>
                    ...
                    <?php $__env->startComponent('maileclipse::layout.emptydata'); ?>

                        <span class="mt-4"><?php echo e(__("We didn't find anything - just empty space.")); ?></span><button class="btn btn-primary mt-3" data-toggle="modal" data-target="#newMailableModal"><?php echo e(__('Add New Mailable')); ?></button>
                    ...
                    <table id="mailables_list" class="table table-responsive table-hover table-sm mb-0 penultimate-column-right">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo e(__('Namespace')); ?></th>
                                <th scope="col"><?php echo e(__('Last edited')); ?></th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php $__currentLoopData = $mailables->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mailable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="mailable_item_<?php echo e($mailable['name']); ?>">
                                <td class="pr-0">
                                    <?php echo e($mailable['name']); ?>

                                </td>
                                <td class="text-muted" title="/tee"><?php echo e($mailable['namespace']); ?> </td>

                                <td class="table-fit"><span><?php echo e((\Carbon\Carbon::createFromTimeStamp($mailable['modified']))->diffForHumans()); ?></span></td>

                                <td class="table-fit">
                                    <a href="<?php echo e(route('viewMailable', ['name' => $mailable['name']])); ?>" class="table-action mr-3"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 16"><path d="M16.56 13.66a8 8 0 0 1-11.32 0L.3 8.7a1 1 0 0 1 0-1.42l4.95-4.95a8 8 0 0 1 11.32 0l4.95 4.95a1 1 0 0 1 0 1.42l-4.95 4.95-.01.01zm-9.9-1.42a6 6 0 0 0 8.48 0L19.38 8l-4.24-4.24a6 6 0 0 0-8.48 0L2.4 8l4.25 4.24h.01zM10.9 12a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path></svg>
                                    </a>

                                    <a href="#" class="table-action remove-item" data-mailable-name="<?php echo e($mailable['name']); ?>">
  ...
  <form id="create_mailable" action="<?php echo e(route('generateMailable')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    axios.post('<?php echo e(route('deleteMailable')); ?>', {
...
<?php echo $__env->make('maileclipse::layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/sections/mailables.blade.php ENDPATH**/ ?>