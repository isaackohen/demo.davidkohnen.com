              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">Time for an upgrade?</span><br><br>
                    ...
                    <br>
                      <div><!--[if mso]>
                        ...
                        <![endif]-->
                            <a href="http://"
                        style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Upgrade now!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                        <![endif]-->
                ...
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <span class="header">Upgrade now and receive a 20% discount!</span><br>
                    ...
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <br><br>
                          <span class="header">Find out what your missing!</span> <br>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/go/upsell.blade.php ENDPATH**/ ?>