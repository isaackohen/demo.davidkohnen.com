      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <!-- === //NEVIGATION SECTION === -->
            <!-- ===  BANNER WITH TEXT AND COUPEN CODE === -->
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">Hi &lt;First Name&gt;
                    </td>
                  </tr>
                  <tr>
                    <td height="26" class="em_height">&nbsp;</td>
                  </tr>
                  <tr>
                    <td valign="middle" align="center"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/birthday.jpg" width="500" height="311" alt="IT'YOUR BIRTHDAY" style="display:block; font-family:Arial, sans-serif; font-size:25px; line-height:311px; background-color:#b4e0ff; color:#fc7097; letter-spacing:4px; font-weight:bold;" class="em_full_img" border="0" /></td>
                  </tr>
                  <tr>
                    <td height="22" class="em_height">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">It&rsquo;s Your Birthday!!</td>
                  </tr>
                  <tr>
                    <td height="13" style="font-size:1px; line-height:1px;" >&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px;  line-height:20px; color:#999999;">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; color:#feae39;">Enjoy 15% OFF for your birthday celebration!</td>
                  </tr>
                  <tr>
                    <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top" class="em_font1" style="font-family:'Open Sans', Arial, sans-serif; font-size:70px; line-height:70px; font-weight:bold; color:#30373b;">15% OFF</td>
                  </tr>
                  <tr>
                    <td height="19" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td valign="top" align="center">
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;">off15code</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/mantra/birthday.blade.php ENDPATH**/ ?>