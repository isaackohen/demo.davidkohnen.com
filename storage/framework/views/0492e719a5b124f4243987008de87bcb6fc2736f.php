                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                           <table>
                              <tr>
                                <td width="80" height="80" style="text-align:left;">
                                  <a href=""><img style="border: 1px solid grey;" width="80" height="80" src="https://www.filepicker.io/api/file/OqRXT4JuRbmXSgbxccgK"></a>
                                </td>
                              </tr>
                              <tr>
                          ...
                          <td>
                            I set up an Awesome Co profile where I can do tons of really awesome stuff and I want you to follow me! Once you join Awesome Co, you'll be able to do all sorts of Awesome stuff too!
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td style="text-align:left; padding-bottom:30px;" >
                              Because I've invited you, you can also use the below coupon code to receive a <b>50% discount</b> on you first months subscription!
                          </td>
                        </tr>
                      </table>
                      <table cellspacing="0" cellpadding="10" width="100%">
                          ...
                          <td width="150" style="width:150px;">
                            <div style="text-align:center; background-color:#48be19;"><!--[if mso]>
                                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#48be19">
                                    <w:anchorlock/>
                                    <center style="color:#ffffff;font-family:sans-serif;font-size:16px;">Sign up now!</center>
                                  </v:roundrect>
                                <![endif]-->
                                <!--[if !mso]><!-- --><a href="#"><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="background-color:#48be19;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:45px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Sign up now!</span></td></tr></table></a>
                                <!--<![endif]-->
                              </div>
                          </td>
                          <td class="hide-for-mobile"  width="94" style="width:94px;">
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td width="130" style="text-align:right; padding:5px;">
                          Discount code:
                          </td>
                          <td width="150" style="border:1px solid #D1D1D1; text-align: left; font-family:courier; font-style:bold; padding-left: 15px;">
                            <b>a29ux$w!#th</b>
                          </td>
                          <td>
                            &nbsp;
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/cleave/invite.blade.php ENDPATH**/ ?>