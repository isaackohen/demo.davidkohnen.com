            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">You're almost there!</td>
                    </tr>
                  </table>
                  <table class="status" bgcolor="#fffeea" cellspacing="0">
                    <tr>
                      <td class="status-cell success">
                          <img class="status-image" src="https://www.filepicker.io/api/file/gd9yTMfATWV8fPJlmyRC" alt="✓">&nbsp;<b>Step&nbsp;1</b>
                      </td>
                      <td class="status-cell success">
                          <img class="status-image" src="https://www.filepicker.io/api/file/gd9yTMfATWV8fPJlmyRC" alt="✓">&nbsp;<b>Step&nbsp;2</b>
                      </td>
                      <td class="status-cell success">
                          <img class="status-image" src="https://www.filepicker.io/api/file/gd9yTMfATWV8fPJlmyRC" alt="✓"> &nbsp;<b>Step&nbsp;3</b>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">3 of 4 steps completed</div>
...
</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/airmail/progress.blade.php ENDPATH**/ ?>