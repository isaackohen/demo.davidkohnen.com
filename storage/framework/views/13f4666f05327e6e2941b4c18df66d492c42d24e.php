...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                  <h5 class="text-center">Just one more step to go</h5>
                </th>
<th class="expander"></th>
        </tr>
      </table>
              ...
              <table class="row"><tbody><tr> <!-- Progress Sections -->
      ...
      <table>
        <tr>
          <th>
                    <br>
                    <h1 class="text-center" valign="middle">1</h1>
      ...
      <table>
        <tr>
          <th>
                    <br>
                    <h1 class="text-center" valign="middle">2</h1>
                    <p class="text-center">Step 2</p>
                  </th>
        </tr>
      </table>
    </th>
                      <th class="grey small-3 large-3 columns">
      <table>
        <tr>
          <th>
                    <br>
                    <h1 class="text-center" valign="middle">3</h1>
      ...
      <table>
        <tr>
          <th>
                    <br>
                    <h1 class="text-center" valign="middle">4</h1>
              ...
              <table class="row"><tbody><tr> <!--This row adds a spacer -->
                    <th class="small-12 large-12 columns first last">
      <table>
        <tr>
          <th>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/meow/progress.blade.php ENDPATH**/ ?>