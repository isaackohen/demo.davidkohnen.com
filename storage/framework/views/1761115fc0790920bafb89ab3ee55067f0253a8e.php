              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">We really miss you!</span><br><br>
                    Things haven't been the same without you. Please give us another try.
                    <br>
                    <br>
                      <div><!--[if mso]>
                        ...
                        <![endif]-->
                            <a href="http://"
                        style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Come back!</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                        <![endif]-->
                ...
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <span class="header">20% discount on your next purchase!</span><br>
                    ...
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <br><br>
                          Our customers are very important to us. We're constantly trying to improve our quality and services to better serve our customers.<br><br>
                          We are continuing to grow and we want you to be a part of it! To welcome you back please accept this 20% discount on your next purchase.
                          <br><br>
                          Sincerely,<br>
                          Awesome Inc
                        </td>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/go/reignite.blade.php ENDPATH**/ ?>