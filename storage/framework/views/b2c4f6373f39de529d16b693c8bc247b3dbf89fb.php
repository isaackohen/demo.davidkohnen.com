...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                  <h5 class="text-center">Your Coupon Code is</h5>
                </th>
<th class="expander"></th>
        </tr>
      </table>
              ...
              <table class="row"><tbody><tr> <!-- Coupon code box -->
      ...
      <table>
        <tr>
          <th></th>
                      ...
                      <th class="grey small-12 large-12 columns">
      <table>
        <tr>
          <th>
                    <br>
                    <h5 class="text-center" valign="middle">2ob3-32cc39-2pe3-291ab</h5>
                  </th>
<th class="expander"></th>
        </tr>
      </table>
      ...
      <table>
        <tr>
          <th></th>
              ...
              <table class="row"><tbody><tr> <!-- Call to Action -->
                    <th class="small-12 large-12 columns first last">
      <table>
        <tr>
          <th>
                  <center data-parsed="">
                    ...
                    <div class="button">
                      <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="8%" strokecolor="#f7931d" fillcolor="#f7931d">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Click here to Activate</center>
                          </v:roundrect>
                      <![endif]-->
                      <a href="#" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;">Click here to Activate</a>
                   </div>
                  </center>
                </th>
<th class="expander"></th>
...
<?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/skeletons/html/meow/coupon.blade.php ENDPATH**/ ?>