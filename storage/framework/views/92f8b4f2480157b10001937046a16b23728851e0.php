<?php $__env->startSection('title', 'Create Template'); ?>
...
<div class="col-lg-12 col-md-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo e(ucfirst($skeleton['type'])); ?></li>
        <li class="breadcrumb-item active"><?php echo e(ucfirst($skeleton['name'])); ?></li>
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(ucfirst($skeleton['skeleton'])); ?></li>
      </ol>
    </nav>
        <div class="container">
            <div class="row my-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <textarea id="template_editor" cols="30" rows="10"><?php echo e($skeleton['template']); ?></textarea>
                      </div>
                ...
                notie.input({
                  ...
                  submitCallback: function (templatedescription) {
                    ...
                    var postData = {
                        ...
                        template_view_name: '<?php echo e($skeleton['name']); ?>',
                        template_type: '<?php echo e($skeleton['type']); ?>',
                        template_skeleton: '<?php echo e($skeleton['skeleton']); ?>',
                    }
                    ...
                    <?php endif; ?>
                        ...
                        axios.post('<?php echo e(route('createNewTemplate')); ?>', postData)
...
<?php echo $__env->make('maileclipse::layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/sections/create-template.blade.php ENDPATH**/ ?>