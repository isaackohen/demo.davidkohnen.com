...
<head>
    <title>MailEclipse - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/maileclipse/css/maileclipse-app.min.css')); ?>">
    <!-- Font Awesome -->
    ...
    <?php if( request()->route()->getName() === 'newTemplate' ||
...
<!-- Editor Markdown/Html/Text -->
    ...
    <script src="<?php echo e(asset('vendor/maileclipse/js/maileclipse-app.js')); ?>"></script>

</head>

<body>

    <?php echo $__env->make('maileclipse::layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <?php if( request()->route()->getName() !== 'newTemplate' && 
                ...
                <?php echo $__env->make('maileclipse::layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('maileclipse::layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

</body>

</html><?php /**PATH /home/ploi/demo.davidkohen.com/vendor/qoraiche/laravel-mail-editor/resources/views/layout/app.blade.php ENDPATH**/ ?>